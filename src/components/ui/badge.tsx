  ...
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        l1: 'border-transparent bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300',
        l2: 'border-transparent bg-amber-100 text-amber-800 dark:bg-amber-900 dark:text-amber-300',
        l3: 'border-transparent bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300',
        // Status badges
        ...
        resolved: 'border-transparent bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300',
        escalated: 'border-transparent bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300',
      },
    },
    defaultVariants: {
      variant: 'default',
